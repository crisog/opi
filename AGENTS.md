...
- Use the Node.js version pinned in `.nvmrc` and `.node-version`, and keep the root engine requirement aligned with it. Published package engines must reflect their actual runtime minimum instead of the development toolchain.
